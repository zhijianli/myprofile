export const site = {
  ...
  aboutParagraphs: [
    "我长居杭州，职业生涯从阿里巴巴 Java 工程师起步，做过的最出圈的产品是天猫超市，产品足够伟大，但我只是冗长流水线上的一颗螺丝钉，这段生涯对我最直接的意义是让我明白很多做事的逻辑与方法论，但当时的我并不明白自己到底想做什么。",
...
export const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "在疗愈与技术的交汇处，综合运用工程、心理学、佛学与产品经验，做出踏实、有用、能帮助他人的产品。",
  },
];
